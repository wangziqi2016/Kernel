...
endmark_total_byte: dw 512 * (($-$$ + 512 + 511) / 512) ; This is the number of bytes
endmark_total_sect: dw ($-$$ + 512 + 511) / 512         ; This is the number of sectors
endmark_endmark:    dw END_MARK                         ; This is the loader end mark
endmark_code_size:                                      ; This symbol represents the size of the loader